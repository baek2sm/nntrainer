...
enum LayerType {
  ...
  LAYER_MEAN = ML_TRAIN_LAYER_TYPE_MEAN,         /**< Mean Layer type */
...
/**
 * @brief Helper function to create mean layer
 */
inline std::unique_ptr<Layer>
MeanLayer(const std::vector<std::string> &properties = {}) {
  return createLayer(LayerType::LAYER_MEAN, properties);
}
