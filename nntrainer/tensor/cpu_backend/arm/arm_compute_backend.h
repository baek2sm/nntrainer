 ...
 * @note Concrete float overload preferred over the never-instantiated template
 * by overload resolution; defined in arm_compute_backend.cpp via
 * nntr_quantize_row_q8_0. Mirrors dequantize_row_q8_0(float) above.
 */
