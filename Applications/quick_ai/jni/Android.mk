...
# Build libquick_ai_core.so (shared library - without api)
include $(CLEAR_VARS)
...
# Build libquick_ai_api.so (shared library - api only)
include $(CLEAR_VARS)
...
LOCAL_SHARED_LIBRARIES := quick_ai_core nntrainer ccapi-nntrainer
LOCAL_STATIC_LIBRARIES := tokenizers_c
...
# Build nntrainer_quick_ai executable
include $(CLEAR_VARS)
...
LOCAL_ARM_MODE := arm
LOCAL_MODULE := nntrainer_quick_ai
LOCAL_LDLIBS := -llog -landroid -DENABLE_FP16=1 -DUSE__FP16=1 -D__ARM_NEON__=1 -march=armv8.2-a+fp16+dotprod+i8mm -DUSE_NEON=1
...
LOCAL_SHARED_LIBRARIES := quick_ai_api quick_ai_core nntrainer ccapi-nntrainer
LOCAL_STATIC_LIBRARIES := tokenizers_c
...
LOCAL_ARM_MODE := arm
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := unittest_quick_ai_models
...
LOCAL_SRC_FILES := \
    $(UNITTEST_MODELS_DIR)/quick_ai_test_utils.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_gemma3.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_gemma3_reference.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_gemma4.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_gemma4_reference.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_qwen3_moe.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_qwen3_moe_reference.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_qwen3_slim_moe.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_qwen3_cached_slim_moe.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_gpt_oss.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_gpt_oss_cached_slim.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_qwen2.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_qwen2_reference.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_qwen3.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_qwen3_reference.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_qwen3_embedding_reference.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_qwen2_embedding_reference.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_embedding_gemma_reference.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_tinybert_reference.cpp \
    $(UNITTEST_MODELS_DIR)/unittest_quick_ai_deberta_v2_reference.cpp
