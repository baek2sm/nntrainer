...
#### [Custom Shortcut Application](https://github.com/nntrainer/nntrainer/tree/main/Applications/Tizen_native/CustomShortcut)

A demo application which enable user defined custom shortcut on galaxy watch.

#### [MNIST Example](https://github.com/nntrainer/nntrainer/tree/main/Applications/MNIST)
...
#### [Reinforcement Learning Example](https://github.com/nntrainer/nntrainer/tree/main/Applications/ReinforcementLearning/DeepQ)

A reinforcement learning example with cartpole game. It is using DeepQ algorithm.

#### [Transfer Learning Examples](https://github.com/nntrainer/nntrainer/tree/main/Applications/TransferLearning)
...
#### [ResNet Example](https://github.com/nntrainer/nntrainer/tree/main/Applications/Resnet)

An example to train resnet18 network.

#### [VGG Example](https://github.com/nntrainer/nntrainer/tree/main/Applications/VGG)

An example to train vgg16 network.

#### [ProductRating Example](https://github.com/nntrainer/nntrainer/tree/main/Applications/ProductRatings)

This application contains a simple embedding-based model that predicts ratings given a user and a product.

#### [SimpleShot Example](https://github.com/nntrainer/nntrainer/tree/main/Applications/SimpleShot)

An example to demonstrate few-shot learning : SimpleShot

#### [Custom Example](https://github.com/nntrainer/nntrainer/tree/main/Applications/Custom)
...
#### [Logistic Regression Example](https://github.com/nntrainer/nntrainer/tree/main/Applications/LogisticRegression)

A logistic regression example using NNTrainer.

#### [Alexnet Example](https://github.com/nntrainer/nntrainer/tree/main/Applications/AlexNet)
