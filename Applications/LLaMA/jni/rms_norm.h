 ...
 *
 */
class RMS_NORM_GAMMA_INIT final : public nntrainer::EnumProperty<nntrainer::props::InitializerInfo> {
public:
  /**
   * @brief Construct a RMS_NORM_GAMMA_INIT object
   */
  RMS_NORM_GAMMA_INIT(nntrainer::Tensor::Initializer value = nntrainer::Tensor::Initializer::ONES) {
    set(value);
  };
