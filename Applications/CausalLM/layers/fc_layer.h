 ...
 *
 */
WIN_EXPORT class FCLayer : public nntrainer::LayerImpl {
public:
  /**
   * @brief Construct a new FC layer object
   *
   */
  WIN_EXPORT FCLayer();

  /**
   * @brief Destroy the FC layer object
   *
   */
  WIN_EXPORT ~FCLayer() {}
...
private:
  std::tuple<nntrainer::props::Unit, props::SmartReply>
      custom_fc_props;                    /**< fc layer properties :
