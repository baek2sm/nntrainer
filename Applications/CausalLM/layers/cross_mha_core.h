...
public:
   ...
   */
  WIN_EXPORT
  CrossMHACoreLayer(CrossMHACoreLayer &&rhs) noexcept = default;

  /**
   * @brief  Move assignment operator.
   * @parma[in] rhs CustomMultiHeadAttentionLayer to be moved.
   */
  WIN_EXPORT CrossMHACoreLayer &operator=(CrossMHACoreLayer &&rhs) = default;
...
}; // end of class CrossMHACoreLayer
} // namespace causallm
