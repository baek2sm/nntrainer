 ...
 *
 * Conformance port of the YOLOv11 path to the standard CausalLM architecture:
 ...
 *
 * All knobs are read from nntr_config.json (standard CausalLM approach), NOT
 ...
 */
void Yolov11Transformer::setupParameters(json &cfg, json &generation_cfg,
                                         json &nntr_cfg) {
  (void)generation_cfg;
...
Yolov11Transformer::constructYoloModel() const {
 ...
 */
std::vector<std::string> Yolov11Transformer::getQuantizableLayerNames() const {
 ...
 */
void Yolov11Transformer::initialize() {
 ...
 */
void Yolov11Transformer::registerCustomLayers() {
 ...
 */
void Yolov11Transformer::run(const WSTR prompt, bool do_sample,
