...
#ifndef __CUSTOM_MHA_CORE_V2_LAYER_H__
#define __CUSTOM_MHA_CORE_V2_LAYER_H__
 ...
 *
 */
WIN_EXPORT class CustomMHACoreV2Layer : public nntrainer::LayerImpl {
public:
  /**
   * @brief Constructor of MhaCore Layer
   */
  WIN_EXPORT CustomMHACoreV2Layer();
   ...
   */
  WIN_EXPORT
  CustomMHACoreV2Layer(CustomMHACoreV2Layer &&rhs) noexcept = default;
   ...
   */
  WIN_EXPORT CustomMHACoreV2Layer &
  operator=(CustomMHACoreV2Layer &&rhs) = default;
  ...
  WIN_EXPORT const std::string getType() const override {
    return CustomMHACoreV2Layer::type;
  };
  ...
  inline static const std::string type = "custom_mha_core_v2";
...
private:
  ...
  inline static bool rotary_embedding_precomputed = false;
  float theta_ = 500000.0f;
...
}; // end of class CustomMHACoreV2Layer
