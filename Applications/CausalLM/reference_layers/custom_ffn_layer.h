...
￼   */
  WIN_EXPORT void incremental_forwarding(nntrainer::RunLayerContext &context, unsigned int from,
...
private:
  float lora_scaling;
  std::tuple<nntrainer::props::Unit, nntrainer::props::LoraRank, custom::props::LoraAlpha,
  std::vector<nntrainer::props::TensorDataType>, custom::props::LoraEnable, props::SkipPrefill>
